...
ALTER TABLE users
MODIFY COLUMN role ENUM('customer', 'provider', 'admin') NOT NULL DEFAULT 'customer';
...
-- User profiles for job seekers/providers
...
-- Job listings created by providers/admin
...
-- Service requests with provider decision and admin payment tracking
